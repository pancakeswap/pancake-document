...
{% tabs %}
{% tab title="Solution" %}
Firstly,[ let the team know](../../contact-us/social-accounts.md) which pool you're trying to unstake from, so they can top up the rewards. If you're in a hurry to unstake and you don't mind losing your pending yield, try an emergencyWithdraw:
