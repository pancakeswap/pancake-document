...
我们将尽可能地在一周内答复。但由于申请数量众多，我们无法保证对所有申请作出回应。若您在申请后两周内没有收到我们的回复，请尝试在 Telegram 上联系 @chef\_roo，并阐述**您的项目名称、代币名称和申请日期。**
...
「前 100 名单」是依据一定时间段内的交易量产生的。至于「扩展列表」，通常开设有农场的项目代币，都会会被加入。PancakeSwap 核心团队择中的其他代币也可能会被加入「拓展列表」

这些名单不接受主动申请加入。用户们仍然可以通过直接输入您的代币的合同地址，来手动添加并保存。
...
由于 PancakeSwap 是基于自动做市机制的去中心化交易所，我们无法阻止任何 BEP-20 代币的交易。我们强烈建议：请确保代币合约在您的网站上清晰可见、可查证，并正确指引您的用户如何安全地交易您的代币。
