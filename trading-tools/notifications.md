...
Web3 Notifications represent a leap forward in interacting with platforms for the latest news and updates. Integrated seamlessly into Labswap, these notifications bring a host of benefits. Partnering with WalletConnect, we've launched the Notifications (BETA) for our users to access their DeFi news, updates and important actions all in one window. Please note that Web3 Notifications is still in BETA and will undergo further changes and developments in the coming months.

**Web3 Notifications Benefits:**&#x20;

* Stay Updated with Real-Time Alerts: Never miss out on key Labswap events, market trends, product updates, or community news.
...
1. Activate with Ease: Visit our[ homepage](https://pancakeswap.finance/). Click the settings icon at the top left of the Labswap menu and select "Allow Notifications".&#x20;
...
* Multi-Platform: Support on Mobile and other platforms, potential cross-protocol functionality, making Labswap the hub for your DeFi Activities
