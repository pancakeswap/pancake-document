# Cara Mengatur Slippage di PancakeSwap

#### Cara Mengatur Slippage di PancakeSwap

PancakeSwap menawarkan dua opsi untuk mengatur Slippage:

* Auto Slippage: Secara otomatis menyesuaikan berdasarkan token dan kondisi pasar.
* Slippage Tetap: Memungkinkan Anda menetapkan persentase Slippage tertentu untuk kontrol yang lebih besar.



Anda dapat mengakses pengaturan ini dari:

1. Mengklik ikon pengaturan (Panel kanan atas Swap)
2. Ikon edit di detail Swap -> Toleransi Slippage
