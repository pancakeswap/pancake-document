...
{% hint style="warning" %}
Check the [UI Kit](https://github.com/pancakeswap/pancake-uikit) before you start doing anything. A lot of components are already created, and we don't want that you waste your time rebuilding the wheel 😉 
{% endhint %}
