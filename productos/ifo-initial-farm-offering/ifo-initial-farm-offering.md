...
## **Ante de la IFO** <a href="#before-the-ifo" id="before-the-ifo"></a>
...
iCAKE determina el máximo de CAKE que puedes comprometer en la venta pública de IFO. Por ejemplo, si tienes 200 iCAKE, podrás comprometer 200 CAKE en la próxima venta pública de IFO. El número de iCAKE que tengas está basado en el número de CAKE depositados en el pool a plazo fijo y la duración total de tu actual staking a plazo fijo.  &#x20;

Para conseguir iCAKE, ve a la [página de IFO](https://pancakeswap.finance/ifo). Encuentra la tarjeta del Pool de CAKE y haga clic en "Locked" (Bloqueado) en "Stake CAKE" para continuar.

Para aprender más acerca de iCAKE y cómo es calculada, mira [este documento.](https://medium.com/pancakeswap/presentamos-icake-actualziaciones-de-ifo-y-el-cake-side-pool-ba0c2873fcee)

### Consigue CAKE

Una vez que tenga un perfil creado y también iCAKE, deberás preparar algunos CAKE en tu billetera. Estos se utilizarán para comprar los tokens que se ofrecen en la IFO.\
\
Si actualmente estás depositando su CAKE en un Pool (flexible o en otro pool), puedes retirarlos antes de la IFO. Asegúrate de que los tokens estén disponibles en tu billetera.
...
La cantidad final de tokens IFO que uno obtendrá se determinará utilizando el método de venta - "Overflow".

#### **Venta Privada (O Ilimitada)** <a href="#unlimited-sale" id="unlimited-sale"></a>

La venta ilimitada no tiene límite en la cantidad de tokens que un usuario puede comprar. Si compras tokens con la venta ilimitada, tendrás que pagar una pequeña tarifa.&#x20;
...
Cuando finalice la IFO, podrás recoger tus nuevos tokens. La cantidad que obtendrás depende de cuántas personas participaron en la IFO. **Se te devolverán todos los CAKE adicionales que hayas comprometido con la IFO que no se hayan utilizado para comprar tokens nuevos.**
...
* La cantidad total de token comprado.
* El número de tokens liberados&#x20;
* El número de tokens disponibles para reclamar.&#x20;
* Cuando el calendario de liberación finaliza

Puedes hacer clic en el botón **Reclamar (Claim)** para reclamar cualquier token disponible en este momento.

A lo largo de todo el programa de vesting, puedes volver a la página de IFO en cualquier momento y reclamar cualquier token disponible.
