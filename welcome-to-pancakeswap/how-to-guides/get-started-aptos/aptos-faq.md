...
查看[我们的跨链指南](aptos-coin-guide.md)了解各种跨链解决方案。

如果你想跨链 CAKE 代币，请查看我们的 [CAKE 跨链指南](cake-bridging-guide.md)。

### 我可以在 Aptos 链上使用哪种钱包？

查看[我们的钱包指南](wallet-guide.md)下载并设置你的 Aptos 钱包。
...
CAKE 代币现已在 Aptos 上线。查看我们的 [CAKE 跨链指南](cake-bridging-guide.md)，了解更多关于在 Aptos 与 BNB Smart Chain 之间跨链 CAKE 代币的信息。
