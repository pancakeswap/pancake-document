...
3. 对于 Blocto，请使用你的电子邮件地址注册或登录。如需了解更多，请查看[此处](wallet-guide.md)。

{% hint style="danger" %}
**记住——在任何情况下，你都绝不应该把你的私钥或助记词提供给任何人。**
{% endhint %}

## **连接到 Aptos Mainnet**

Aptos 有多个网络，包括多个 devnet 和 testnet。但要在 Aptos 链上使用 PancakeSwap，请务必确保你的钱包已连接到 **Aptos Mainnet**。&#x20;
