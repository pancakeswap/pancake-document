...
如需获取关于迁移时间表的更多消息和更新，请[在 Twitter 上关注我们的社交渠道或 Telegram 公告。](../../contact-us/social-accounts.md)

### 我什么时候可以开始迁移？

如果你正在阅读本文，迁移很可能已经开始了。访问 [https://pancakeswap.finance/migration](https://pancakeswap.finance/migration) 了解更多详情。
...
如需了解如何在 V3 中添加流动性的详细教程，请阅读[此处](../../../earn/pancakeswap-pools/liquidity-guide.md)。&#x20;

如需了解如何在 V3 中进行农场耕作的教程，请阅读[此处](../../../earn/yield-farming/how-to-use-farms/)。
