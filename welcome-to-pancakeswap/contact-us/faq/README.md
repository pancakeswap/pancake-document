...
* Transparent:
  ...
  * Our contracts are verified on blockchain explorers, so you know that what you see is what you get. Check them out [here](https://developer.pancakeswap.finance/contracts/v2/addresses).
