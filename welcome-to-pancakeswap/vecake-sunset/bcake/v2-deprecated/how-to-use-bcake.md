...
要了解更多关于如何进行固定期限 CAKE 质押的信息，请阅读[此处](../../../../archive/legacy-products/new-cake-pool/#fixed-term-staking)。
...
要激活加成，请点击"加成"按钮，并在你的钱包中确认交易。

{% hint style="info" %}
请注意，任何对农场或 CAKE 质押池的用户操作都会根据农场和 CAKE 质押池的最新数据和统计信息自动更新你的加成倍数。
...
请注意，取消设置后，赚取的 CAKE 将被收获到农场加成器合约中，并将在你下次收获、存款或提款时自动发送到你的钱包。在[此处](../faq.md#where-are-my-cake-rewards-after-activating-or-unsetting-the-booster)了解更多。
