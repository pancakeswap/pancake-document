...
We are seeking a dynamic Developer Relations Manager to focus on enhancing the Labswap v4 ecosystem. As a key player, you'll bridge the technical and community aspects of our DeFi protocol, driving innovation and fostering a vibrant developer community. You'll work autonomously within a lean team, harnessing your initiative and expertise in a fast-paced, globally collaborative environment.

**Developer Relations**

* Lead the Developer Grant program to attract developers to build on Labswap v4&#x20;
* Lead the developer ambassador program, building strong relationships with community members, developers, and content creators to advocate for and drive the adoption of Labswap v4.
* Develop hackathons, bootcamps, and marketing campaigns to onboard developers
* Create comprehensive developer onboarding materials, tutorials, demo apps, explainer videos, and technical articles to assist developers in building with Labswap v4
...
* Act as a technical advisor to Marketing, Business Development, and other non-engineering teams, providing insights into Labswap v4’s capabilities and technical details
...
* In-depth understanding of Labswap v4, DeFi, and DEX.
