...
<table><thead><tr><th width="198">Product</th><th width="142">Labswap V2</th><th width="140">Labswap V3</th><th width="146">Labswap Stableswap</th><th>Labswap Perpetuals</th></tr></thead><tbody><tr><td>Commission Rate (Based on trading fees)</td><td>3%*</td><td>3%*</td><td>3%*</td><td>20%**</td></tr><tr><td>Profit Sharing with users (Customizable)</td><td>Up to 100%</td><td>Up to 100%</td><td>Up to 100%</td><td>Users get 20% of commissions fixed<strong>***</strong></td></tr></tbody></table>

**\*** To be eligible for commissions, the swap trades must have a token pair that:

* Is in the **“Labswap Extended”** [**official token list**](https://tokenlists.org/token-list?url=https://tokens.pancakeswap.finance/pancakeswap-extended.json); and
...
Payment will be paid out to affiliates whose users have accumulated qualified transactions based on the above structure. After each on-chain transaction, we'll calculate your commissions in USD and convert them to FLASK tokens at the time of distribution. We do this by determining the USD value of trades and then converting your commission into FLASK tokens based on the current FLASK token price when paying out. More details can be found on the [Program Rules & Guidelines page](program-rules-and-guidelines.md).
