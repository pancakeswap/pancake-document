...
3.  Follow the steps on the profile setup screen, from step 7 onwards. The setup is free, however a small amount of gas on the BNB Chain is required to set up profiles.
