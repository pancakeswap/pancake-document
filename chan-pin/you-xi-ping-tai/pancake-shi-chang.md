...
这个小游戏可以让玩家获得额外的市长货币（Mayor Cash）和保护城市的工具。玩家通过旋转转盘来匹配符号，并获得不同的奖励。
...
是的！像 CAKE 爆炸（CAKE blast）、突袭暴走（raid madness）、攻击暴走（raid madness）和凤梨冲刺（pineapple rush）这样的特殊活动提供了获得更大奖励的机会，其中有 CAKE 加密货币。\
...
| 描述                               | 百分比 (%) | 说明                                                                      |
| -------------------------------- | ------- | ----------------------------------------------------------------------- |
| 下个赛季的初始奖池                        | 30%     | 当前赛季花费的 CAKE 的 30% 将保留给下个赛季的初始奖池                                        |
| 当前赛季的奖励                          | 40%     | 当前赛季花费的 CAKE 的 40% 将根据排名发放                                              |
| 转盘小游戏                            | 10%     | 玩小游戏可赢取的 CAKE                                                           |
