...
{% hint style="warning" %}
PancakeSwap está basado en Uniswap v2. Lea la [Uniswap v2: documentación](https://uniswap.org/docs/v2/).  
Para más info lea [Uniswap v2:  whitepaper](https://uniswap.org/whitepaper.pdf).
{% endhint %}
