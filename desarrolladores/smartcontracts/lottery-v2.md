...
Emitter: `buyTickets` [go to buyTickets](broken-reference)
...
Emitter: `claimTickets` [go to claimTickets](broken-reference)
...
Emitter: `recoverWrongTokens` [go to recoverWrongTokens](broken-reference)
...
Emitter: `closeLottery` [go to closeLottery](broken-reference)
...
Emitter: `injectFunds` [go to injectFunds](broken-reference)
...
Emitter: `startLottery` [go to startLottery](broken-reference)
...
Emitter: `drawFinalNumberAndMakeLotteryClaimable` go to [drawFinalNumberAndMakeLotteryClaimable](broken-reference)
...
Emitter: `setOperatorAndTreasuryAndInjectorAddresses` [go to setOperatorAndTreasuryAndInjectorAddresses](broken-reference)
...
Emitter: `changeRandomGenerator` [go to changeRandomGenerator](broken-reference)
