...
糖浆池是在 PancakeSwap 上赚取免费代币的最简单方式。\
质押 CAKE，赚取免费代币。就是这么简单。

部分特殊糖浆池还允许你质押 CAKE 以外的其他代币！
...
{% content-ref url="../../../archive/legacy-products/new-cake-pool/flexible-staking.md" %}
[flexible-staking.md](../../../archive/legacy-products/new-cake-pool/flexible-staking.md)
{% endcontent-ref %}

{% content-ref url="../../../archive/legacy-products/new-cake-pool/fixed-term-staking.md" %}
[fixed-term-staking.md](../../../archive/legacy-products/new-cake-pool/fixed-term-staking.md)
{% endcontent-ref %}
...
{% content-ref url="../../earn-faq/cake-staking-faq/syrup-pool-faq.md" %}
[syrup-pool-faq.md](../../earn-faq/cake-staking-faq/syrup-pool-faq.md)
{% endcontent-ref %}

### **我该如何为我的项目运营一个糖浆池？**

在[此处](../../../welcome-to-pancakeswap/contact-us/business-partnerships/syrup-pools.md)查找有关我们糖浆池的更多信息，并使用链接中的相关申请表进行申请。
...
[CAKE 糖浆池](/broken/pages/cFidohif6VdJE7LuwvlB)
