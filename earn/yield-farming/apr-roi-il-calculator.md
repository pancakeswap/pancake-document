...
* The estimated amount of FLASK rewards is based on the live FLASK emissions to the farms. They are subject to change based on future emission adjustments.
...
* Farm page, within the position under each farm - showing combined APR with LP fee and FLASK rewards\
...
{% hint style="info" %}
In V3, LP fees and earned FLASK has to be manually harvested and compounded.
{% endhint %}
