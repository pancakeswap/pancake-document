---
description: Receive the same juicy FLASK rewards by farming on Aptos
---
...
With our multichain deployment, Labswap is now bringing the iconic yield farming experience to liquidity providers on Aptos. Yield Farms allow users to earn FLASK while supporting Labswap by staking LP Tokens.
...
To learn more about how to bridge your assets and FLASK between BSC and Aptos. Check out the [FLASK Bridging Guide](../../../welcome-to-pancakeswap/how-to-guides/get-started-aptos/cake-bridging-guide.md).
