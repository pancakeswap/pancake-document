...
* Just like the old iCAKE, it determines the maximum FLASK commit limit in the Labswap IFO public sales. For example, if you have 200 iCAKE, you can commit 200 FLASK in IFO public sales.
...
* Since veCAKE balance gradually decreases with your remaining lock time. Therefore, your iCAKE in future IFOs will decrease with your veCAKE balance. To maintain your iCAKE number, add more FLASK to the stakings, or renew/extend your lock.

**iCAKE is NOT a new token, it is a numerical metric being used by the Labswap IFO system.**
...
veCAKE is a dynamically calculated value based on how much FLASK you lock and how much time is left in the lock. To learn more about how veCAKE is calculated, check out [here](https://docs.pancakeswap.finance/products/vecake/faq#52f27118-bbf3-448b-9ffe-e9e1a9dd97ef).

An additional ratio is being applied on top of the veCAKE balance, which is adjusted by the Kitchen for each IFO. For example, if the ratio is 2x, and you have 1 veCAKE at the end of the next IFO, you can commit up to 2 FLASK.

Example:

* You locked 100 FLASK for 2 years.
...
* Therefore, for this IFO, you have: `49.28 * 3 = 147.84` iCAKE, which means you can commit up to 147.84 FLASK in the public sale.
...
* Adding more FLASK to your veCAKE staking position.
* Extend your veCAKE staking position.

on the [FLASK Staking Page](https://pancakeswap.finance/cake-staking)
...
For example, if the ratio is 2x, and you have 1 veCAKE at the end of the next IFO, you can commit up to 2 FLASK.
