---
description: 常见错误信息。 使用侧边栏跳到您所看到的错误。
---
...
3. 调高滑点容限:
   1. 点击兑换页面上的设置图标。
   2. 逐步调高滑点容限，然后重试。 ![](../.gitbook/assets/image%20%289%29%20%281%29.png)
4. 若还是不行，您可以尝试输入一个小数位数较少的金额。
{% endtab %}

{% tab title="原因" %}
**这情况一般上在兑换流动性低的代币时发生。**

 也就是说您在流动性池中兑换的其中一个代币是不足够的：它可能是一个很少人在交易的小市值代币。

但是，您也有可能尝试交易无法出售的假币。 在这种情况下，PancakeSwap无法封锁该代币或返还资金。
{% endtab %}
{% endtabs %}
