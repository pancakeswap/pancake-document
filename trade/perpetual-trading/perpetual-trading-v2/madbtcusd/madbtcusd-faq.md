# MADBTCUSD よくある質問 (FAQ)

### MADBTCUSDインデックスはどのように計算されますか？

MADBTCUSDは以下の計算式に基づいて算出されます：
...
* 初期Sn=1000 &#x20;
* dt=1
* expected vol：100%（expected volはMADBTCの期待時間ボラティリティ）
* 「**ランダムナンバー**」は**小数点以下8桁の精度のBTC価格**に基づいて計算されます
...
決定されたランダムナンバーが0の場合、再計算されます。

### BTCとMADBTCUSDの過去の価格をどこでクロス検証できますか？

BTCとMADBTCUSDの価格フィードはこちらでご確認いただけます：
...
### BTCとMADBTCの過去のバックテストデータ

BTCとMADBTCの過去の価格をクロス検証するために、以下にバックテストグラフを提供します。&#x20;
