...
Perpetuals Trading V1, our order book perpetual engine, is available on Ethereum. Order Book Perpetuals are usually found on centralised exchanges, and rely on an established system where buy and sell orders are matched. V1 generally offers better speed, as transactions are settled off-chain. Users deposit their funds into the engine and withdraw funds back to their wallet after all trades.&#x20;
