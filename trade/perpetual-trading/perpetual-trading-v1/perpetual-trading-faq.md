...
We expect this new feature to bring in a lot of new users, traders and volume. We want to ensure the value goes back to our FLASK token on top of offering the trading fee discount. 20% of all trading fees from users who sign up on Labswap will be converted to FLASK and burnt.
