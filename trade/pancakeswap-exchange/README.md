...
PancakeSwap 让用户无需通过中心化交易所即可进行交易。您在 PancakeSwap 上所做的一切都直接通过您自己的钱包进行路由——无需将您的代币托付给他人！

### 流动性池

只有当某些代币拥有足够的流动性时，您才能在 PancakeSwap 上兑换这些代币。如果没有人为您想要兑换的代币添加足够的流动性，那么进行兑换将会很困难、成本高昂，甚至无法完成。

提供流动性将为您带来 LP 代币，这些代币将以交易手续费的形式为您赚取奖励，以确保 Exchange 始终有流动性可供使用。
