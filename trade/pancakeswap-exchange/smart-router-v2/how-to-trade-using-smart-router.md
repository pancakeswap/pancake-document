...
开始之前，需要一个**兼容 BNB Chain 的钱包以及用于支付 gas 费用的 BNB。**有关更多详情，请查看我们的[钱包指南](../../../welcome-to-pancakeswap/how-to-guides/get-started/wallet-guide.md)。
...
4\.  使用底部一行路由字段中的图标查看新路由。一切就绪！后续的兑换流程与平常相同。如果这是你第一次交易，请查看[此处的指南。](../trade-guide.md)
