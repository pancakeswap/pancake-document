...
Além da alavancagem, os futuros abrem a possibilidade de negociação em ambas as direções, comprando (long) e vendendo (short) perpétuos. Além disso, permite que a PancakeSwap ofereça mais ativos para negociar, mesmo ativos que não estão atualmente na BNB Smart Chain (BSC). Os contratos perpétuos não expiram e permitem que o holder aproveite a ação do preço de negociação do ativo subjacente sem possuí-lo.
