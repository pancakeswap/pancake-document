...
IFO开始后，在公开销售页面能够实时看到叠加了「超募手续费」后每颗代币的成本价格。如果您的页面没有及时更新，请尝试刷新页面。
...
&#x20;IFO 销售活动结束后，IFO 页面将出现一个**代币分期释放**区域。在此区域您可以找到此代币分期释放的整个时间表以及信息，包括但不仅限于：
...
您可以单击“Claim”认领按钮来认领当前可领取的任何代币。在代币分期释放期间，不论是否完全释放完毕，您都可以随时返回 IFO 页面并认领任何可领取的代币。
...
糖浆池挖取的 IFO 代币也可以投入农场，赚取交易手续费以及挖取 CAKE。

在[此处](../yield-farming.md)阅读有关农场的信息。
