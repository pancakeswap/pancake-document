...
公开销售参与费，在公开销售出现超额认购的情况时就需要支付，根据「超额认购」倍数有不同的手续费%数，在每期IFO投票页面可以查看当期公开销售参与费的计算方式。
...
IFO开始后，在公开销售页面能够实时看到叠加了「公开销售参与费」后每颗代币的成本价格。如果您的页面没有及时更新，和请尝试刷新页面。
