...
### 哪些变量会影响新 CAKE 糖浆池的 APY（灵活和锁仓质押选项）？&#x20;
...
当您的定期质押期结束并且您的 CAKE 解锁时，您有 7 天的时间来完成以下两个选项之一：
...
在这 7 天内，您仍可以获得CAKE收益。

7 天后，如果您还没有完成上述两个选项之一，您质押的 CAKE 将进入所谓的「到期燃烧」。 在「到期燃烧」中，您的 CAKE 收益将会开始被逐步发送到销毁地址销毁。销毁的百分比会在 90 天内线性增加。直到「到期燃烧」比率达到100%，这代表着所有收益都会被销毁（不会影响您的质押本金）。

&#x20;因此，为避免损失 CAKE 奖励，我们建议您开始新的锁仓质押期或在锁仓质押期结束时将您的 CAKE 转换为灵活质押。
